# Bash - Web stack debugging #1

## Description of the file inside this folder:

0. Find out what’s keeping your Ubuntu container’s Nginx installation from listening on port 80. Create a bash script to fix the server to listening on port 80 of all the server’s active IPv4 IPs.
